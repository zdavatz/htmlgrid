...
class TestLabel < Test::Unit::TestCase
	...
	def test_to_html1
		...
		expected << '<TD><LABEL>Label</LABEL></TD>'
		expected << '<TD>component</TD></TR>'
		expected << '<TR><TD><LABEL>Named Label</LABEL></TD>'
	...
	def test_to_html2
		...
		expected = '<TABLE cellspacing="0"><TR><TD><LABEL>Label</LABEL></TD><TD>component</TD></TR><TR><TD><LABEL class="error">Named Label</LABEL></TD><TD>component</TD></TR></TABLE>'
		assert_equal(expected, @composite.to_html(CGI.new))
	end
	def test_to_html3
		@composite.named_component(nil, nil).mey = 'mey'
		@session.state = StubLabelState.new({:named_component => 'ein Error'})
		expected = '<TABLE cellspacing="0"><TR><TD><LABEL>Label</LABEL></TD><TD>component</TD></TR><TR><TD><LABEL class="e-mey">Named Label</LABEL></TD><TD>component</TD></TR></TABLE>'
		assert_equal(expected, @composite.to_html(CGI.new))
	end
end
